...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Report Bug`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://wa.me/62882276067014?text=bang+ada+yang+error"}}}, { quoted: m})
        }
...
case 'webtonsearch': case 'webtoon':
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) return reply(`Example : ${prefix + command} 62882276067014`)
...
break
                    case 'bug': case 'report': {
                    	...
                    	XeonBotInc.sendMessage(`62882276067014@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break
                    
            case 'info': case 'infobot': case 'informasi': case '?': {
            	timestampe = speed();
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
                ...
                break
                case 'lisgggt': case 'mgggenu': case 'hehbhlp': case '?': {
...
│✙ 𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : ${os.platform()}
│✙ 𝗧𝗼𝘁𝗮𝗹 𝗨𝘀𝗲𝗿 : ${Object.keys(global.db.data.users).length}`,
                    description: `list menu ada dibawah gan\n\n`,
                    buttonText: "Menu",
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "Owner Menu",
										"description": "menu ini khusus owner",
										"rowId": `${prefix}ownermenu`
										},
									{
										"title": "Menu Grup",
										"description": "Hanya Bisa Digunakan Ketika Didalam Grup",
									...
									{
										"title": "menu download",
										"description": "menu untuk mendownload via WhatsApp",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "Menu Pencarian",
										"description": "Untuk Membantu Lebih Mudah ketika Mencari Sesuatu",
									...
									},
									{
										...
										"description": "menampilkan anime acak",
										"rowId": `${prefix}randomanimemenu`
										},
										{
											"title": "Fun Menu",
										"description": "menu bersenang senang",
										...
										{
											"title": "Database Menu",
										"description": "menu untuk menyimpan database",
										...
										{
											"title": "Islamic Menu",
										"description": "masyaallah brother",
								...
								"rows": [
									{
										...
										"description": "menu untuk mencari teman",
										"rowId": `${prefix}anonymous`
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "laporkan bug",
										"description": "pilih menu ini jika terdapat bug/error!!",
										"rowId": `${prefix}bugreport`
									}
								]
							}
						],
          listType: 1
            ...
            break
    case 'donffffasi': case 'doggggnate': case 'segggwabot': case 'seggggwa': case 'buyprgg&emium': case 'dgggonate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/6ba2aed566865a068e91f.jpg' }, caption: `*Hi Bro ${m.pushName}*\n\nDonate Me : \n\n 🌂 Fampay : https://telegra.ph/file/6ba2aed566865a068e91f.jpg\n 🌂 Paytm : https://telegra.ph/file/577bd4f28d90ca2c7f369.jpg\n\nIf You Want To Donate, Talk With The Owner First\nwa.me/62882276067014 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'bugreport': case 'bndnsnnsug': {
                reply(`kontak saya : https://wa.me/62882276067014`)
            }
            break
case 'list': case 'menu': case 'help': case '?': case 'semua menu': case 'command':  case 'allmenu': {
  	anu = `
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: `https://wa.me/62882276067014?text=bang+ada+yang+error`
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'info',
...
┃╠ ${prefix}listgc
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
